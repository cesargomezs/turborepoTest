...
const API_DONATIONS_URL = 'http://192.168.252.243:3000/donations';
...
export default function DonationsScreen() {
  ...
  const handlePublish = async () => {
    ...
    try {
      ...
      const uploadResponse = await fetch('http://192.168.252.243:3000/api/subir-imagen-optimizada/donations', {
        method: 'POST',
        body: formData,
