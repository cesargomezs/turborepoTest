...
const API_COMMUNITY_URL = 'http://192.168.1.201:3000/community'; 
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      if (selectedImage) {
        ...
        const uploadResponse = await fetch('http://192.168.1.201:3000/api/subir-imagen-optimizada/community', {
          method: 'POST',
          body: formData,
          headers: { 
