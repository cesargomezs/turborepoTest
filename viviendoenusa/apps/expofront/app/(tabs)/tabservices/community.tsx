...
const APP_SCHEME = 'expofront-scheme';
...
export default function CommunityScreen() {
  ...
  const getTranslatedTag = (tag: string) => {
    ...
    switch(base) {
      case 'Experience': return t.communitytab.typepostAdd[0];
      case 'Question': return t.communitytab.typepostAdd[1];
      case 'Advice': return t.communitytab.typepostAdd[2];
      default: return tag;
    }
  };
              ...
              <View style={styles.cardContent}>
                ...
                <View style={[localStyles.filterBar, { flexDirection: 'row', alignItems: 'center' }]}>
                  <TouchableOpacity 
                    ...
                    style={[styles.chip, { borderColor: isRecentFirst ? '#FF5F6D' : 'rgba(255,255,255,0.2)', marginRight: 10 }]}
                  >
                  ...
                  <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 2 }}>
                    {t.communitytab.typepost.map(filter => {
                      const isActive = tagMapping[filter] === tagMapping[activeFilter];
                      return (
                        <TouchableOpacity 
                          key={filter} 
...
const localStyles = StyleSheet.create({
  ...
  voteBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.1)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 },
  voteCount: { marginLeft: 6, fontSize: 13, fontWeight: 'bold', color: '#fff' },
  shareBtn: { backgroundColor: 'rgba(255,255,255,0.1)', padding: 8, borderRadius: 20 },
