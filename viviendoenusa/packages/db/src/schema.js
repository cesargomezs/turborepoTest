import { pgTable, uuid, text, timestamp, date, boolean, integer, doublePrecision, numeric, jsonb } from "drizzle-orm/pg-core";
...
export const users = pgTable("users", {
    ...
    roleId: uuid("role_id").references(() => typeDetail.id, { onDelete: "cascade" }),
